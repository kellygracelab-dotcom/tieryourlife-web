export const en = {
  ...
  settings: {
    ...
    hiddenEmptyTitle: "Everything is showing",
    hiddenEmptyBody:
      "Lists and people you hide in the community wait here, in case you change your mind.",
  ...
  search: {
    ...
    categories: "Category",
    all: "All",
    nothing: "No lists match “{q}”",
    browseHint: "Try a shorter word, or check the spelling. Or browse {where}.",
  ...
  feed: {
    ...
    emptyBody: "Lists people make public show up here.",
  ...
  list: {
    ...
    edit: "Edit",
    delete: "Unpublish",
    deleteTitle: "Unpublish this list?",
    deleteBody:
    ...
    deleteFailed: "Could not unpublish it. Try again in a minute.",
  ...
  rank: {
    ...
    dock: "Where the cards sit",
    dockBeside: "Cards beside the board",
    dockUnder: "Cards under the board",
  ...
  me: {
    ...
    remove: "Unpublish",
    removeAsk:
      "Unpublish “{title}”? It leaves the feed and its link stops working. Rankings people already made from it stay. A board on your phone stays on your phone.",
    keepIt: "Keep it",
    removing: "Deleting…",
